...
@Component({
  ...
  styleUrl: "./head-approved-funds.component.css",
})
export class HeadApprovedFundsComponent implements OnInit, OnDestroy {
  ...
  // which view to show (based on query param 'type')
  // viewType: "topup" | "payout" | null = null;
  ...
  ngOnInit(): void {
    ...
    // if (this.branchId) {
    //   this.fetchUpiTopups(); // default view
    // }
  ...
  // ======== Approved Payouts (replace existing) ========
  ...
  // ============ Template Helpers ============
  // UPI topups - Use server-side pagination, no frontend filtering needed
  filteredUpitopups(): any[] {
    return this.upitopups; // Directly return the array from server
  }

  pagedUpitopups(): any[] {
    return this.upitopups; // Server already returns paginated data
  }
  ...
  // Bank topups - Use server-side pagination
  ...
  // Payouts - Use server-side pagination
